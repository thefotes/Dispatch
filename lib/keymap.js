...
//
// An AG-bound key sends no keystroke, but it is not silent: it reports itself
// over HID as {"m":"v.oai.hid","p":{"k":"AG01","act":1}}. Note the abbreviated
// envelope - m/p, not method/params, which responses use. Matching on "method"
// drops every key event and makes AG keys look inert.
